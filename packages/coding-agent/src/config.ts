...
// This build appends a "+kvcache" marker so the compaction-optimized fork is distinguishable via `pi --version`.
export const VERSION: string = `${pkg.version || "0.0.0"}+kvcache`;
